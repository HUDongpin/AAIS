...
export function createInitialGuideMessages(displayName: string): GuideMessage[] {
  return [
    {
      id: "assistant-welcome",
      kind: "assistant",
      text:
        `你好，${displayName}！我是你的认知学徒制 AI 助教。今天你想学习什么？我可以陪你练习解决问题，或者帮你整理学习笔记。`,
      turns: [
        {
          agentId: "A1",
          label: "导学智能体",
          content:
            `你好，${displayName}！我是 A1 导学智能体。今天你可以先选一个入口，我会帮你明确目标、邀请 A2 专家智能体示范思考，或给出逐步减少的支架。需要专家时，也可以直接输入 @专家智能体。`,
